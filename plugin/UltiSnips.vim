...
if !exists("g:UltiSnipsVisualExpandTrigger")
    let g:UltiSnipsVisualExpandTrigger = "<tab>"
endif
...
function! UltiSnips_MapKeys()
    ...
    exec 'xnoremap ' . g:UltiSnipsVisualExpandTrigger. ' :call UltiSnips_SaveLastVisualSelection()<cr>gv"_s'
